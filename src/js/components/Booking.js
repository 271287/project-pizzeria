...
class Booking {
  ...
  initActions() {
    ...
    thisBooking.hourPicker.dom.input.addEventListener('updated', function () {
      if (bookedTable.???) {
        tables.classList.remove('booked');
      }
    });
    ...
    thisBooking.dom.bookFunction.addEventListener('submit', function (event) {
